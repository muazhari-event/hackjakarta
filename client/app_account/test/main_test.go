...
func a1(ctx *autocode.OptimizationApplicationContext, args ...any) (result any) {
	n := int64(1)
	count := int64(0)
	for i := int64(1); i < n; i++ {
		for j := int64(1); j < n; j++ {
...
func b1(ctx *autocode.OptimizationApplicationContext, args ...any) (result any) {
	n := ctx.GetValue("a").(int64)
	count := int64(0)
...
func b2(ctx *autocode.OptimizationApplicationContext, args ...any) (result any) {
	n := int64(1)
	count := int64(0)
	for i := int64(1); i < n; i++ {
		for j := int64(1); j < n; j++ {
...
func c0(ctx *autocode.OptimizationApplicationContext, args ...any) (result any) {
...
func c1(ctx *autocode.OptimizationApplicationContext, args ...any) (result any) {
	n := int64(1)
	count := int64(0)
